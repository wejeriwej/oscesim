...
//  }
    ...
    if(noteContent.includes("name") && noteContent.includes("age")) {
      ...
      document.getElementById("mp4_src").src = "marcjevner.mp4"; document.getElementById("myVideo").load(); document.getElementById('myVideo').onended = function(e) {
      recognition.start();  document.getElementById('listeninggif').style.display = 'unset';    document.getElementById('stop-consultation-btn').style.display = 'unset';
  ...
  document.getElementById("mp4_src").src = "videos/shoulder.mp4"; document.getElementById("myVideo").load(); document.getElementById('myVideo').onended = function(e) {
    ...
    else if (noteContent.includes("any other medical")||noteContent.includes("past medical")||noteContent.includes("medical conditions")||(noteContent.includes("medical")&&noteContent.includes("problems"))) {
    ...
    const prompt = "you are Marc, a 31 year old male. with constant severe heavy chest pain since this morning. You're in a consultation room & the Dr is asking you questions. Answer as Marc"
...
let generalhistorycounter = 0;
      ...
      var painlocationtest = $('#painlocationtest'); var painlocationtest1 = $('#painlocationtest1');
        ...
        painlocationtest.css('color', 'rgb(249, 221, 221)');
      ...
      var onsettest = $('#onsettest'); var onsettest1 = $('#onsettest1');
        if (onsetx === true){
        onsettest.css('color', 'rgb(249, 221, 221)');
      ...
      var charactertest = $('#charactertest'); var charactertest1 = $('#charactertest1');
        if (characterx === true){
        charactertest.css('color', 'rgb(249, 221, 221)');
      ...
      var timecoursetest = $('#timecoursetest'); var timecoursetest1 = $('#timecoursetest1');
        if (timecoursex === true){
        timecoursetest.css('color', 'rgb(249, 221, 221)');
      ...
      if (radiatex === true){
        radiatetest.css('color', 'rgb(249, 221, 221)');
      ...
      if (associatedsymptomsx === true){
        associatedsymptomstest.css('color', 'rgb(249, 221, 221)');
      ...
      if (makeitworsex === true){
        makeitworsetest.css('color', 'rgb(249, 221, 221)');
      ...
      if (makeitbetterx === true){
        makeitbettertest.css('color', 'rgb(249, 221, 221)');
      ...
      if (ratepainx === true){
        ratepaintest.css('color', 'rgb(249, 221, 221)');
      ...
      if (happenbeforex === true){
        happenbeforetest.css('color', 'rgb(249, 221, 221)');
...
/**/
      ...
      if (ideasx === true){
        ideastest.css('color', 'rgb(249, 221, 221)');
      ...
      if (concernsx === true){
        concernstest.css('color', 'rgb(249, 221, 221)');
      ...
      if (expectationsx === true){
        expectationstest.css('color', 'rgb(249, 221, 221)');
      ...
      if (familyhistoryx === true){
        familyhistorytest.css('color', 'rgb(249, 221, 221)');
      ...
      if (pmhx === true){
        pmhtest.css('color', 'rgb(249, 221, 221)');
      ...
      if (surgicalx === true){
        surgicaltest.css('color', 'rgb(249, 221, 221)');
      ...
      if (medsx === true){
        medstest.css('color', 'rgb(249, 221, 221)');
      ...
      if (allergiesx === true){
        allergiestest.css('color', 'rgb(249, 221, 221)');
...
/**/
      ...
      var jobtest = $('#jobtest'); var jobtest1 = $('#jobtest1');
      if (jobx === true){
        jobtest.css('color', 'rgb(249, 221, 221)');
        jobtest1.css('color', 'rgb(0, 0, 0)');
        generalhistorycounter++
        //document.getElementById('colorbox: jobtest').style.backgroundColor = 'brown';

      }

      var walkdistancetest = $('#walkdistancetest'); var walkdistancetest1 = $('#walkdistancetest1');
      if (walkdistancex === true){
        walkdistancetest.css('color', 'rgb(249, 221, 221)');
      ...
      if (homesituationx === true){
        homesituationtest.css('color', 'rgb(249, 221, 221)');
      ...
      if (smokingx === true){
        smokingtest.css('color', 'rgb(249, 221, 221)');
      ...
      if (alcoholx === true){
        alcoholtest.css('color', 'rgb(249, 221, 221)');
...
/*important not to miss*/
      ...
      if (FHheartconditionsx === true){
        FHheartconditionstest.css('color', 'rgb(249, 221, 221)');
        FHheartconditionstest1.css('color', 'rgb(0, 0, 0)');
        generalhistorycounter++
        $('#FHheartconditionstest-comment').css('color', 'rgb(249, 221, 221)');
        $('#FHheartconditionstest-comment2').css('color', 'rgb(0, 0, 0)');
      }

      var diabetestest = $('#diabetestest'); var diabetestest1 = $('#diabetestest1');
      if (diabetesx === true){
        diabetestest.css('color', 'rgb(249, 221, 221)');
        diabetestest1.css('color', 'rgb(0, 0, 0)');
        generalhistorycounter++
        $('#diabetestest-comment').css('color', 'rgb(249, 221, 221)');
      ...
      if (hypertensionx === true){
        hypertensiontest.css('color', 'rgb(249, 221, 221)');
        hypertensiontest1.css('color', 'rgb(0, 0, 0)');
        generalhistorycounter++
        $('#hypertensiontest-comment').css('color', 'rgb(249, 221, 221)');
      ...
      if (physicalactivityx === true){
        physicalactivitytest.css('color', 'rgb(249, 221, 221)');
        physicalactivitytest1.css('color', 'rgb(0, 0, 0)');
        generalhistorycounter++
        $('#physicalactivitytest-comment').css('color', 'rgb(249, 221, 221)');
      ...
      if (palpitationsx === true){
        palpitationstest.css('color', 'rgb(249, 221, 221)');
        palpitationstest1.css('color', 'rgb(0, 0, 0)');
        generalhistorycounter++
        $('#palpitationstest-comment').css('color', 'rgb(249, 221, 221)');
