...
//  }
    ...
    const prompt = "you are Jill, a 50 year old female. with pain. Imagine you are in a consultation room and the doctor is asking you questions and you are answering as Jill for all of the next questions."
...
*/
    ...
    const handleUserInput = async (noteContent) => {
      ...
      const videoPromise = new Promise((resolve) => {
        ...
        gptvideo.src = 'WIN_20230328_13_59_49_Pro.mp4';
        gptvideo.load();
      });
...
handleUserInput(userInput); // Will output "50 years old" as a voice response
