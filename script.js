...
//  }
    ...
    //Opening question    
    else if (painlocationrepeat === false&&((!noteContent.includes("family")||!noteContent.includes("other"))&&(noteContent.includes("brought")||noteContent.includes("bring")||noteContent.includes("what can")||noteContent.includes("why")
        ...
        ||noteContent.includes("problem")&&(!noteContent.includes("medical")||!noteContent.includes("other"))))) {
    ...
    ||noteContent.includes("sore throat")||noteContent.includes("chills")) {
  //readOutLoud("No");
  associatedsymptomsx = true;
  document.getElementById("mp4_src").src = "videos/no.mp4"; document.getElementById("myVideo").load(); document.getElementById('myVideo').onended = function(e) {
    recognition.start();  document.getElementById('listeninggif').style.display = 'unset';    document.getElementById('stop-consultation-btn').style.display = 'unset';
    ...
    else if (!noteContent.includes("famil")&&((noteContent.includes("medical")&&(noteContent.includes("problem")||noteContent.includes("condition")||noteContent.includes("issue"))))) {
    ...
    else if (noteContent.includes("anything else")||noteContent.includes("other problem")||noteContent.includes("other condition")) {
      //readOutLoud("I don't think so.");
      pmhx = true;
      document.getElementById("mp4_src").src = "videos/idontthinkso.mp4"; document.getElementById("myVideo").load(); document.getElementById('myVideo').onended = function(e) {
        recognition.start();  document.getElementById('listeninggif').style.display = 'unset';    document.getElementById('stop-consultation-btn').style.display = 'unset';
        }}//SUffer from anyhing else? make thisvery general and broad answer
