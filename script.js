...
function startFunction() { 
  ...
  recognition.start();  document.getElementById('listeninggif').style.display = 'unset'; document.getElementById('enter3times').style.display = 'unset';  document.getElementById('stop-consultation-btn').style.display = 'unset';
...
function initialstopConsultation(){
  ...
  recognition.stop(); document.getElementById('listeninggif').style.display = 'none'; document.getElementById('enter3times').style.display = 'none';   document.getElementById('stop-consultation-btn').style.display = 'none';
...
function movetoQuestions(){
  ...
  document.getElementById('myVideo').onended = function(e) {
  recognition_examinations.start();  document.getElementById('listeninggif').style.display = 'unset'; document.getElementById('enter3times').style.display = 'unset'; // document.getElementById('stop-consultation-btn').style.display = 'unset';
...
function movetoQuestions_examinations(){
  ...
  recognition_examinations.stop(); document.getElementById('listeninggif').style.display = 'none'; document.getElementById('enter3times').style.display = 'none';   document.getElementById('stop-consultation-btn').style.display = 'none';


  document.getElementById("mp4_src").src = "WIN_20230328_13_59_37_Pro.mp4"; document.getElementById("myVideo").load();

  document.getElementById('myVideo').onended = function(e) {
  recognition1.start();  document.getElementById('listeninggif').style.display = 'unset'; document.getElementById('enter3times').style.display = 'unset'; // document.getElementById('stop-consultation-btn').style.display = 'unset';
...
silenceTimer = setTimeout(function() {
  ...
  recognition.stop();
  //newQuestion();
  document.getElementById('listeninggif').style.display = 'none'; document.getElementById('enter3times').style.display = 'none';document.getElementById('stop-consultation-btn').style.display = 'none';
...
document.getElementById('myVideo').style.display = 'none';
recognition_examinations.stop(); document.getElementById('listeninggif').style.display = 'none'; document.getElementById('enter3times').style.display = 'none';   document.getElementById('stop-consultation-btn').style.display = 'none';
document.getElementById('save-note-btn-for-examinations').style.display = 'none';
...
$('#save-note-btn-for-summary').on('click', function(e) {
  ...
  setTimeout(function() {
    ...
    recognition_summary.onstart = function() {recordinginstructionsforsummary.text('Microphone is activated. Try speaking into the microphone. Then double click the Submit Question button.');}
    recognition_summary.onspeechend = function() {
    recordinginstructionsforsummary.text(notesummary);//IMPORTANT DO NOT DELETE!!!!
  }
    recognition_summary.onerror = function(event) {if(event.error == 'no-speech') {recordinginstructionsforsummary.text('No speech was detected. Try again.');  };}
...
document.getElementById('differentials').style.display = 'unset';
document.getElementById('myVideo').style.display = 'none';
recognition1.stop(); document.getElementById('listeninggif').style.display = 'none'; document.getElementById('enter3times').style.display = 'none';   document.getElementById('stop-consultation-btn').style.display = 'none';
document.getElementById('save-note-btn-for-summary').style.display = 'none';
